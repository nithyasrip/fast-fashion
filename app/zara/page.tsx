  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen">
      ...
      <button className="bg-white rounded-lg mt-[-50px]">
        ...
        Bad choice! Over the course of one year, Zara alone produces about 840 million garments for its 6,000 stores worldwide. One kilogram of fabric production emits about 23 kilograms of greenhouse gasses. Try again!
        </div>
      </button>
      <div className="mt-4">
